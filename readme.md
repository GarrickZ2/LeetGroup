...
# Features of Project Launch (iteration 3)
...
- We also provide `Archive` button for card. While you believe you don't want check this card in certain time (but also don't want to delete it.) Then you can archive the card and you can find those archived card in our `archive page`
...
- `Card comments` function now are available, you and your friend can share comments under the same card and share your thoughts.
