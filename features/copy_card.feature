...
Scenario: copy a card
  ...
  And I click the element with id "copy-card-modal-btn"
  And I click the element with id "copy-card-btn"
  Then I go to the all cards page
  And I click the element with id "card-detail-btn-3"
  Then I should see "Two Sum"